...
abstract class $ProviderEntityCopyWith<$Res> {
  factory $ProviderEntityCopyWith(
    ProviderEntity value,
    $Res Function(ProviderEntity) then,
...
abstract class _$$ProviderEntityImplCopyWith<$Res>
    implements $ProviderEntityCopyWith<$Res> {
  factory _$$ProviderEntityImplCopyWith(
    _$ProviderEntityImpl value,
...
class __$$ProviderEntityImplCopyWithImpl<$Res>
  ...
  __$$ProviderEntityImplCopyWithImpl(
    _$ProviderEntityImpl _value,
    $Res Function(_$ProviderEntityImpl) _then,
  ) : super(_value, _then);
...
class _$ProviderEntityImpl implements _ProviderEntity {
  ...
  @override
  String toString() {
    return 'ProviderEntity(id: $id, name: $name, type: $type, specialty: $specialty, city: $city, country: $country, rating: $rating, reviewCount: $reviewCount, languages: $languages, isVerified: $isVerified, tags: $tags, imageUrl: $imageUrl, phone: $phone, email: $email, website: $website, bio: $bio)';
  }
